...
# 1) Основной роутер: админ‑CRUD для шаблонов рекомендаций и планов
...
# 2) Вложенный роутер: CRUD тренировок внутри планов
...
urlpatterns = [
    ...
    # ViewSet routes for templates, plans, and workouts
